...
Route::group(['prefix' => LaravelLocalization::setLocale(),
    ...
    Route::name('front.')->group(function () {
        ...
        Route::get(LaravelLocalization::transRoute('routes.contact'), [ContactController::class, 'index'])
            ->name('contact.index');
        Route::post(LaravelLocalization::transRoute('routes.send'), [ContactController::class, 'contact'])
            ->name('contact.send');
        // Fine arts
